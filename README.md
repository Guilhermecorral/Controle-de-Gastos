...
[![Version](https://img.shields.io/badge/release-1.4.5--beta.1-F59E0B)](CHANGELOG.md)

**Em desenvolvimento: v1.4.5-beta.1.** A Agenda de Proventos B3 está disponível somente para o piloto autorizado, gera previsões revisáveis e nunca cria receita sem confirmação explícita. Toda importação
...
Para contribuir ou trabalhar com agentes no repositório, consulte as [regras de contribuição](docs/Rules/README.md).
...
A versão em desenvolvimento é a **1.4.5-beta.1**. O desenvolvimento segue incrementalmente pelo [changelog](CHANGELOG.md), com foco na conferência de importações e em integrações financeiras experimentais, sempre revisadas pelo usuário.
